...
_sambam_complete()
{
    ...
    local global_flags="--name --listen --allow -x --no-advertise --readonly --daemon --pidfile --logfile --config --verbose --hide-dotfiles --username --password --expire --gen-config --version --help"
