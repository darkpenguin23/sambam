...
_sambam_complete()
{
    ...
    local global_flags="--name --listen --username --password --readonly --expire --daemon --verbose --hide-dotfiles --allow --no-advertise --config --gen-config --pidfile --logfile --version --help"
