...
complete -c sambam -n "__fish_sambam_no_subcommand" -s c -l config -r -f -a "(__fish_complete_path)" -d "Additional config file"
...
complete -c sambam -n "__fish_sambam_no_subcommand" -s u -l username -r -d "Require authentication with this username"
...
complete -c sambam -n "__fish_sambam_no_subcommand" -s G -l gen-config -r -f -a "(__fish_complete_path)" -d "Generate config TOML and exit"
